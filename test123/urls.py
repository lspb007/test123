...
from check.views import AddUserAskView,AddSrcView,AddNetView,AddUserAskView1,AddUserAskView2,AddUserAskView3
...
urlpatterns = [
    ...
    url(r'^add_ask3/$', AddUserAskView3.as_view(), name="add_ask3"),
    url('checknewmediainfo/$', views.checknewmediainfo),
]
