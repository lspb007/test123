...
class NewMediasAdmin(object):
    list_display = ['Ins_Item', 'resource_system']
    search_fields = ['Ins_Item', 'resource_system']
    list_filter = ['Ins_Item', 'resource_system']


class usercheckNewMediaAdmin(object):
    list_display = ['user_name', 'add_time', 'insitem_id', 'service', 'details']
    search_fields = ['user_name', 'insitem_id', 'service', 'details']
    list_filter = ['user_name', 'add_time', 'insitem_id', 'service', 'details']
...
xadmin.site.register(NewMedia,NewMediasAdmin)
xadmin.site.register(usercheckNewMedia,usercheckNewMediaAdmin)