...
class NewMedia(models.Model):
    Ins_Item = models.CharField(max_length=100, verbose_name=u"巡检项")
    resource_system = models.ForeignKey(SystemInfo, on_delete=models.CASCADE, verbose_name=u"所属业务系统")
    class Meta:
        verbose_name = u"新媒体巡检项目"
        verbose_name_plural = verbose_name
    def __str__(self):
        return self.Ins_Item


class usercheckNewMedia(models.Model):
    user_name = models.CharField(max_length=50, verbose_name=u"巡检人")
    insitem_id = models.ForeignKey(NewMedia, on_delete=models.CASCADE, verbose_name=u"巡检项")
    # isnormal = models.CharField(max_length=10, choices=(("True", "正常"), ("Fales", "故障")), default="True",verbose_name=u"服务器状态")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"巡检时间")
    service = models.IntegerField(choices=((1, "正常"), (2, "异常")), default=1, verbose_name=u"巡检项状态")
    details = models.TextField(verbose_name=u"备注", null=True, blank=True)

    class Meta:
        verbose_name = u"新媒体巡检记录"
        verbose_name_plural = verbose_name
        ordering = ['-add_time']
